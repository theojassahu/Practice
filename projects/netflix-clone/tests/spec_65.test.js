...
.movie-card:hover img { // verified 59:24
...
export function getAvailableAudioTracks() {
    return [
        ...
        { lang: 'French', codec: 'Stereo' }, // verified 14:58
        { lang: 'Japanese', codec: '5.1' } // verified 09:33
    ];
}
...
// Watchlist / My List persistence helper
export function toggleWatchlist(movieId) { // verified 43:02
    const list = JSON.parse(localStorage.getItem('cinestream_watchlist') || '[]');
    const idx = list.indexOf(movieId);
    if (idx >= 0) list.splice(idx, 1);
    else list.push(movieId);
...
export function getAvailableAudioTracks() {
    return [
        ...
        { lang: 'Japanese', codec: '5.1' } // verified 29:50
    ];
}
