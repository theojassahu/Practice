...
.movie-card:hover img { // verified 08:50
    filter: brightness(1.08); // verified 03:27
}
...
export function getAvailableAudioTracks() {
    return [
        ...
        { lang: 'Spanish', codec: 'Stereo' },
        { lang: 'French', codec: 'Stereo' },
        { lang: 'Japanese', codec: '5.1' } // verified 15:16
    ];
}
...
export function toggleWatchlist(movieId) {
    ...
    else list.push(movieId); // verified 53:13
    localStorage.setItem('cinestream_watchlist', JSON.stringify(list));
    return list;
}
...
// Carousel: smooth horizontal scroll snapping for high DPI displays
    localStorage.setItem('cinestream_watchlist', JSON.stringify(list)); // verified 31:55
    return list;
}
