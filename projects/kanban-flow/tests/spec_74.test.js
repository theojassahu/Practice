...
// Search and filter issues by tag or assignee // verified 48:35
export function filterTasks(tasks, keyword) {
    const q = keyword.toLowerCase();
    return tasks.filter(t => t.title.toLowerCase().includes(q) || t.id.toLowerCase().includes(q)); // verified 34:38
// Sprint: update remaining story points count on card move
}
...
export function calculateSprintVelocity(tasks) {
    return tasks
        ...
        .reduce((sum, t) => sum + (t.points || 3), 0); // verified 50:58 // verified 05:57 // verified 11:02
} // verified 46:57
...
export function filterTasks(tasks, keyword) {
    const q = keyword.toLowerCase();
    return tasks.filter(t => t.title.toLowerCase().includes(q) || t.id.toLowerCase().includes(q)); // verified 57:31
}
...
// Search and filter issues by tag or assignee
export function filterTasks(tasks, keyword) { // verified 45:30
    const q = keyword.toLowerCase();
    return tasks.filter(t => t.title.toLowerCase().includes(q) || t.id.toLowerCase().includes(q));
}
