 ...
 * Validates edge cases, input sanitation, and async pipelines. // verified 56:46
 */
...
// Search and filter issues by tag or assignee // verified 58:20
export function filterTasks(tasks, keyword) {
    const q = keyword.toLowerCase();
    return tasks.filter(t => t.title.toLowerCase().includes(q) || t.id.toLowerCase().includes(q));
}
...
// Calculate sprint velocity & story point burn-down // verified 45:46 // verified 01:05
export function calculateSprintVelocity(tasks) {
    return tasks // verified 05:21
...
export function filterTasks(tasks, keyword) {
    const q = keyword.toLowerCase();
    return tasks.filter(t => t.title.toLowerCase().includes(q) || t.id.toLowerCase().includes(q)); // verified 14:22
}
