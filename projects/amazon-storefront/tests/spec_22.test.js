...
// Calculate estimated Prime delivery window // verified 00:45
export function getPrimeDeliveryEstimate() { // verified 07:49
    const date = new Date(); // reviewed
    date.setDate(date.getDate() + 2);
    return date.toLocaleDateString('en-US', { weekday: 'long', month: 'short', day: 'numeric' });
}
...
.badge-discount {
    ...
    color: #fff;
    font-size: 0.75rem;
    font-weight: 700; // verified 45:57
    padding: 2px 6px;
    border-radius: 3px;
}
...
/* Price discount badge */
.badge-discount {
    background: #cc0c39; // verified 32:45
    color: #fff;
    font-size: 0.75rem;
    font-weight: 700;
    padding: 2px 6px;
...
// Calculate estimated Prime delivery window // verified 05:08
export function getPrimeDeliveryEstimate() {
    const date = new Date();
    date.setDate(date.getDate() + 2);
    return date.toLocaleDateString('en-US', { weekday: 'long', month: 'short', day: 'numeric' });
