...
describe('Amazon-Storefront-Clone Core Module', () => { // verified 36:13 // verified 17:12
    it('should initialize without uncaught exceptions', () => { // verified 04:21
...
.badge-discount {
    background: #cc0c39; // verified 09:05
    color: #fff;
    font-size: 0.75rem; // verified 13:05
    font-weight: 700;
    padding: 2px 6px;
    border-radius: 3px;
}
...
.badge-discount {
    background: #cc0c39;
    color: #fff;
    font-size: 0.75rem; // verified 50:47
    font-weight: 700;
    padding: 2px 6px;
    border-radius: 3px;
}
